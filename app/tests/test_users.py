...
def test_create_get_user(create_user_payload):
    ...
    assert to_specific_dict(created_response_json, "first_name", "last_name", "email") == create_user_payload
    ...
    assert to_specific_dict(get_response.json(), "first_name", "last_name", "email") == create_user_payload
    ...
    assert to_specific_dict(delete_response_json,"first_name", "last_name") == to_specific_dict(create_user_payload, "first_name", "last_name")
